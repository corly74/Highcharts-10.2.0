...
(function (a) {
    "object" === typeof module && module.exports
      ...
      ? define("highcharts/themes/brand-dark", ["highcharts"], function (b) {
          a(b);
          a.Highcharts = b;
          return a;
        })
    ...
    b(
      a,
      "Extensions/Themes/BrandDark.js",
      ...
      function (a, c) {
        ...
        (function (a) {
          a.options = {
            colors: "#8087E8 #A3EDBA #F19E53 #6699A1 #E1D369 #87B4E7 #DA6D85 #BBBAC5".split(
              " "
            ),
            chart: {
              backgroundColor: {
            ...
            tooltip: { borderWidth: 0, backgroundColor: "#f0f0f0", shadow: !0 },
            legend: {
            ...
            plotOptions: {
              ...
              map: { borderColor: "rgba(200, 200, 200, 1)", nullColor: "#78758C" }
            },
            drilldown: {
          ...
          a.apply = function () {
            d(
              ...
              {
                href:
                  "https://fonts.googleapis.com/css2?family=IBM+Plex+Sans:200,300,400,600,700",
                rel: "stylesheet",
                type: "text/css"
              },
              null,
    ...
    b(
      a,
      "masters/themes/brand-dark.src.js",
      [a["Core/Globals.js"], a["Extensions/Themes/BrandDark.js"]],
      function (a, b) {
        a.theme = b.options;
        b.apply();
      }
